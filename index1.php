        ...
        if(isset($_GET) && !empty($_GET))
        {
            ...
            $sql = "SELECT * FROM cars WHERE categoryid=$categoryid";
            $result = $conn->query($sql);
        }
                        ...
                        <div class="shop-widget">
                            <div class="shop-widget-top">
                                <aside class="widget widget-categories">
                                    ...
                                    <a href="category_register.php"><input type="" class="btn btn-danger btn-lg btn-block"  value="++Category"/></a><p></p>
                                    <p>
        <a href="cars.php"><input type="" class="btn btn-danger btn-lg btn-block"  value="CARS LIST"/></a>
                                </p>
                                </aside> 
